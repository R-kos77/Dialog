...
4. Alternatively, download the latest .aab release from the repository and install it using:

   BundleTool (bundletool install-apks)

Author: Robel Kiros  
GitHub: [R-Kos77](https://github.com/R-kos77/Dialog)  
